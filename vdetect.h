...
class VDetect{
    ...
    ******************************************/
    void rehash(); //helps with redesigning table
    void transferData(); //helper for rehash
    bool uniqueInsert(Virus virus); //helper of rehash
    int m_sizeAtStart; //keeps track of starting bound
};
#endif